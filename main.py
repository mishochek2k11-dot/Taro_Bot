...
CARDS = [
    ...
    {"name": "Четвёрка Кубков", "img": "Cups04.png", "description": "Апатия, размышление, упущенные возможности."},
    ...
    {"name": "Рыцарь Кубков", "img": "Cups12.png", "description": "Романтика, приглашение, следование за мечтой."},
